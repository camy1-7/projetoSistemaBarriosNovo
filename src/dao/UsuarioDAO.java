...
public class UsuarioDAO extends DAO_Abstract{
    ...
    public Object list(int id) {
        ...
        criteria.add(Restrictions.eq("clbIdusuario", id)); //adiciona uma Restriction que seria uma restrição, que substitui a clausala WHERE - é uma classe statica que não instancia
