...
public class VendedorDAO extends DAO_Abstract{
    ...
    public Object list(int id) {
        ...
        criteria.add(Restrictions.eq("clbIdvendedor", id)); //adiciona uma Restriction que seria uma restrição, que substitui a clausala WHERE - é uma classe statica que não instancia
