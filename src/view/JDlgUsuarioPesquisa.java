...
public class JDlgUsuarioPesquisa extends javax.swing.JDialog { 
    private JDlgUsuario jDlgUsuario; //criou um atributo privado 
    ...
    public JDlgUsuarioPesquisa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Usuarios Pesquisa");
        setLocationRelativeTo(null);
        //lembrando que o usuariosControle traz o numero de linhas, colunas e o conteudo das cedulas
        usuarioController = new UsuarioController(); //criei o usuarios controle 
        UsuarioDAO usuarioDAO = new UsuarioDAO(); //criou o objeto usuarios_DAO
        List lista = usuarioDAO.listAll(); //Criou uma lista e ta passando o metodo ListAll do Usuarios_DAO
    ...
    public void setTelaAnterior(JDlgUsuario jDlgUsuario){//esse metodo é pra fazer uma conexão com a tela de Uusarios principal de cadastro
        this.jDlgUsuario = jDlgUsuario; //agora ela exerga a tela e elas tem uma conexão
    }
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        ClbUsuario clbUsuario = usuarioController.getBean(rowSel); //criou o bean e chamou a linha selecionada 
        jDlgUsuario.beanView(clbUsuario); //chama o benaView pra mostrar na tela 
        setVisible(false);
