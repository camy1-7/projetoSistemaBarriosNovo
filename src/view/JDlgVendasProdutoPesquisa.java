 ...
 * @author DELL
 */
public class JDlgVendasProdutoPesquisa extends javax.swing.JDialog {
    private JDlgVendas jDlgVendas; //criou um atributo privado 
    VendasProdutoController vendasProdutoController; //global a classe
     ...
     */
    public JDlgVendasProdutoPesquisa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        List lista = vendasProdutoDAO.listAll(); //Criou uma lista e ta passando o metodo ListAll do Vendas_DAO
        ...
        jTable1.setModel(vendasProdutoController); //agora o vendasControle que controla a tabela
    }
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        clbVendasProduto = vendasProdutoController.getBean(rowSel); //criou o bean e chamou a linha selecionada 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgVendasProdutoPesquisa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgVendasProdutoPesquisa dialog = new JDlgVendasProdutoPesquisa(new javax.swing.JFrame(), true);
